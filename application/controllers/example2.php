...
/**
*  This function gets parametrs and passes them to the view example2more
*  The example url http://yourdomain.com/index.php/example2/more/1/2/3 so $a = 1, $b = 2, $c = 3
*/
...
// variable: $rows value: array('a' => $a, 'b' => $b, 'c' => $c);
        $view_params = ['mega_title' => 'Codeigniter - Passing url parameters to view',
        					 'rows' => $rows,
        					 'main' => 'example2more'
        					 ];
